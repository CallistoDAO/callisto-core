...
library ModuleTestFixtureGenerator {
    ...
    function generateFixture(Module module_, Permissions[] memory requests_) public returns (address) {
    ...
    function generateGodmodeFixture(Module module_, string memory contractName_) public returns (address) {
    ...
    function generateMultiFunctionFixture(Module module_, bytes4[] calldata funcSelectors_) public returns (address) {
    ...
    // Generate a test fixture policy authorized for a single module function
    function generateFunctionFixture(Module module_, bytes4 funcSelector_) public returns (address) {
