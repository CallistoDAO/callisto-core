...
/**
 * @title IDLGTEv1
 * @notice Interface for the Olympus DAO Delegation (DLGTE) module v1
 * @dev This interface is based on the Olympus V3 DLGTE module for gOHM delegation functionality.
 * Source: https://github.com/OlympusDAO/olympus-v3/blob/master/src/modules/DLGTE/IDLGTE.v1.sol
 */
interface IDLGTEv1 {
    // =========  ERRORS ========= //
    ...
    function gOHM() external view returns (IERC20Metadata);
