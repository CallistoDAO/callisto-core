...
import { Kernel, Keycode, Module, toKeycode } from "../../Kernel.sol";
import { CallistoToken, MINTRv1 } from "./MINTR.v1.sol";

/// @notice Wrapper for minting and burning functions of callToken token.
contract CallistoMinter is MINTRv1 {
    //============================================================================================//
    //                                      MODULE SETUP                                          //
    //============================================================================================//
    ...
    /// @inheritdoc MINTRv1
    function mintCALL(address to_, uint256 amount_) external override permissioned onlyWhileActive {
